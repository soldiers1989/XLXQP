...
public class MatchLoadingUI : WindowBase
{
    public readonly static string UIAssetName = "MatchLoadingUI";
...
/// 加载数据界面的数据
/// </summary>
public class MatchLoadingUIData
{
    public MatchLoadingUIData()
    {
        MaxLastTime = 10;
    }
