...
/// 加载界面
/// </summary>
public class LoadingUI : WindowBase
{
    public static readonly string UIAssetName = "LoadingUI";
    ...
    /// </summary>
    [SerializeField]
    GameObject m_ProgressGameObject = null;
    ...
    /// 强制显示更新进度条
    /// </summary>
    public void ForceProgressSetActive()
    {
        if (m_ProgressGameObject != null)
        {
            m_ProgressGameObject.SetActive(true);
        }
    }
