...
public class ShuffleAnimation2 : MonoBehaviour
{
    ...
    void InitOneLeftAnimationPath(Transform leftRoot, int index, float disappearOffsetTime = 1f)
    {
        ...
        // 合牌 动画
        leftXiaPath.Frames.Add(new AnimationFrame(leftXiaPath.HandleTransform) { Time = disappearOffsetTime, Active = true });
        leftXiaPath.Frames.Add(new AnimationFrame(leftXiaPath.HandleTransform) { localPosition = leftXiaPath.HandleTransform.localPosition + new Vector3(90, 0, 0), Time = disappearOffsetTime + 0.3f, Active = true });
    ...
    void InitRightAnimationPath(Transform rightRoot, int index, float disappearOffsetTime = 1f)
    {
        ...
        // 合牌 动画
        rightXiaPath.Frames.Add(new AnimationFrame(rightXiaPath.HandleTransform) { Time = disappearOffsetTime, Active = true });
        rightXiaPath.Frames.Add(new AnimationFrame(rightXiaPath.HandleTransform) { localPosition = rightXiaPath.HandleTransform.localPosition + new Vector3(90, 0, 0), Time = disappearOffsetTime + 0.3f, Active = true });
