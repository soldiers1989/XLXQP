...
namespace UnityEditor.UI
{
    ...
    public class ScrollRectExtendEditor : ScrollRectEditor
    {
		...
		private SerializedProperty m_SlideSensitivityProperty = null;
        ...
        protected override void OnEnable()
        {
			...
			m_SlideSensitivityProperty = m_Object.FindProperty("m_SlideSensitivity");
            base.OnEnable();
        }
        ...
        public override void OnInspectorGUI()
        {
			...
			m_SlideSensitivityProperty.floatValue = EditorGUILayout.FloatField (new GUIContent("Slide Sensitivity"), m_SlideSensitivityProperty.floatValue);
