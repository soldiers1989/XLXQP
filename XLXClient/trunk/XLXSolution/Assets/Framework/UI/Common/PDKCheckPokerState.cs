...
[XLua.LuaCallCSharp]
public class PDKCheckPokerState : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler
{
    /// <summary>
    /// 按钮长按事件
    /// </summary>
    [Serializable]
    public class ButtonLongHaveEvent : UnityEvent<bool> { }
    ...
    [SerializeField]
    private ButtonLongHaveEvent m_OnLongPressed = new ButtonLongHaveEvent();
    /// <summary>
    /// 长按事件
    /// </summary>
    public ButtonLongHaveEvent onLongPressed
    {
    ...
    ///<sunmmary>
    ///扑克牌是否处于被选中状态(1未选中 2已选中 3已出牌)
    ///</sunmmary>
    public int PokerState = 1;
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        m_OnLongPressed.Invoke(true);
        m_OnLongPressed.Invoke(false);
    }
