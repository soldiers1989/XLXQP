...
public class ButtonSizeChange : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler
{
    /// <summary>
    /// 物体X轴大小
    /// </summary>
    public float SizeValue_x = 0;
	/// <summary>
    /// 物体Y轴大小
    /// </summary>
    public float SizeValue_y = 0;
	/// <summary>
    /// 物体Z轴大小
    /// </summary>
    public float SizeValue_z = 0;
    ...
    {
        //print("鼠标按下！！！！！！！！");
		gameObject.transform.localScale = new Vector3 (SizeValue_x, SizeValue_y, SizeValue_z);
    }
