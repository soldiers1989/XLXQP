...
namespace Common
{
    ...
    public class FileUtility
    {
        ...
        public static string GetAssetFilePath(string fileName, PathType pathType)
        {
            ...
            {
                case PathType.Cache:
                    rootPath = AppDefine.LOCAL_TEMP_PATH;
                    break;
                case PathType.Remote:
                    rootPath = AppDefine.REMOTE_DATA_PATH;
                    break;
                case PathType.InitData:
                    rootPath = AppDefine.LOCAL_INIT_DATA_PATH;
                    break;
                case PathType.Local:
                default:
                    rootPath = AppDefine.LOCAL_DATA_PATH;
                    break;
            }
        ...
        {
            // 本地数据目录时候包含
            return ExistsDirectory(AppDefine.LOCAL_DATA_PATH);
        }
