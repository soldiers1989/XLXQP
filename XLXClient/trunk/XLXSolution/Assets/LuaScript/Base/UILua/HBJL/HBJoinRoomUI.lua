...
function ReturnButton_OnClick()
    -- 关闭加入房间按钮
    CS.WindowManager.Instance:CloseWindow("HBJoinRoomUI", false)
end
...
function SendJoinRoomMessage()
    print("进入红包接龙包间:",tonumber(roomID))
    NetMsgHandler.Send_CS_HB_Enter_Room1(tonumber(roomID),0)
end
