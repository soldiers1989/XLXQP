...
function StoreButtonOnClick(StoreId)
    ...
    local configData = data.StoreConfig[10+StoreId]
...
function EnterPDKRoom1()
    NetMsgHandler.Send_CS_PDKPP_Enter_Room(1,0)
end
-- 进入跑得快中级场
function EnterPDKRoom2()
    NetMsgHandler.Send_CS_PDKPP_Enter_Room(2,0)
end
-- 进入跑的快高级场
function EnterPDKRoom3()
    NetMsgHandler.Send_CS_PDKPP_Enter_Room(3,0)
end
-- 进入跑得快土豪场
function EnterPDKRoom4()
    NetMsgHandler.Send_CS_PDKPP_Enter_Room(4,0)
end
