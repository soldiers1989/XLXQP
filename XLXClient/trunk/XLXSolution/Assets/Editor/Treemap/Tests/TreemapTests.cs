...
namespace Treemap
{
	...
	public class TreemapTests
	{
		...
		public void Empty()
		{
			Assert.Throws<ArgumentException>(() => Utility2.GetTreemapRects (new float[0], s_Rect));
		}

		[Test]
		public void One()
		{
			var result = Utility2.GetTreemapRects (new [] { 1.0f }, s_Rect);
		...
		{
			var result = Utility2.GetTreemapRects (new [] { 1.0f, 1.0f }, s_Rect);
		...
		public void Zero()
		{
			Assert.Throws<ArgumentException>(() => Utility2.GetTreemapRects (new [] { 0f }, s_Rect));
		}

		[Test]
		public void NegativeNumber()
		{
			Assert.Throws<ArgumentException>(() => Utility2.GetTreemapRects (new [] { -3f }, s_Rect));
		}

		[Test, TestCaseSource("InterestingDataSets")]
		public void ResultRectsHaveCorrectArea(float[] floats)
		{
			var results = Utility2.GetTreemapRects (floats, s_Rect);
