...
class RechargeController extends BaseController
{
    ...
    public function timeSlotIncome()
    {
        ...
        for ($i = 0; $i < 24; $i++) {
            ...
            $fields_ = array('SUM(bk_RealAmount) AS amount1', 'COUNT(bk_AccountID) AS count1', 'COUNT(DISTINCT bk_AccountID) AS count2',
            ...
            $data_list_ = M('bk_createorder')->field($fields_)->where($where_data1)->select();
            foreach ($data_list_ as $key => $val) {
                $data['order'] = $i + 1;
            ...
            $fields = array('SUM(bk_RealAmount) AS amount2', 'COUNT(bk_AccountID) AS count3', 'COUNT(DISTINCT bk_AccountID) AS count4',
            ...
            $data_list = M('bk_createorder')->field($fields)->where($where_data2)->select();
            foreach ($data_list as $key => $val) {
