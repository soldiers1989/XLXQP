			...
			<ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
				<li class="layui-nav-item layui-hide-xs" lay-unselect>
					<a href="javascript:return false;" >
						帐号：<?php echo ($agent["bk_bk_accound"]); ?>
						<!-- 如果有新消息，则显示小圆点 -->
					</a>
				</li>
				...
				<li class="layui-nav-item layui-hide-xs" lay-unselect>
					<a href="javascript:return false;" >
					ID：<?php echo ($agent["bk_accountid"]); ?>
						<!-- 如果有新消息，则显示小圆点 -->
					</a>
				</li>
				<li class="layui-nav-item layui-hide-xs" lay-unselect>
					<a href="javascript:return false;" >
						余额：<span id="balance_span"><?php echo ($gold); ?></span>
						<!-- 如果有新消息，则显示小圆点 -->
					</a>
				</li>
				...
				<li class="layui-nav-item" lay-unselect>
					<a href="javascript:;">
						<cite><?php echo ($agent["bk_gamenickname"]); ?></cite>
					</a>
					<dl class="layui-nav-child">
						<dd><a lay-href="<?php echo U('index/editPasswd');?>">修改密码</a></dd>
						<hr>
						<dd layadmin-event="logout" style="text-align: center;"><a href="<?php echo U('index/quit');?>">退出</a></dd>
					</dl>
				</li>
			...
			<div class="layui-side-scroll">
				...
				<ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
						...
						<a href="javascript:;" lay-tips="组件" lay-direction="2">
							...
							<dl class="layui-nav-child">
								<dd data-name="cz">
									<a href="javascript:" lay-href="<?php echo U('index/recharge');?>">游戏冲值</a>
								</dd>

								<dd data-name="jl">
									<a href="javascript:" lay-href="<?php echo U('index/record');?>">冲值记录</a>
								</dd>
							</dl>
					</li>
				</ul>
	...
	<script>
		layui.config({
            ...
            setInterval(function () {
                $.post("<?php echo U('index/getUserGold');?>", { is_ajax: 1 }, function (data) {
                    $('#balance_span').html(data.gold);
                });
            }, 3000);
        });
	</script>
